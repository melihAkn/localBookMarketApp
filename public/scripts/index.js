    ...
    fetch(apiUrl) 
        ...
        .then(bookData => {
            ...
            if (cardContainer.children.length === 0) {
                console.log('Div içeriği boş.');
                const message = document.createElement("p")
                message.innerHTML = "seçili sehirde kitap yok"
                cardContainer.appendChild(message)
            } else {
            }
...
document.addEventListener('DOMContentLoaded',getCityOptions)
//document.addEventListener('DOMContentLoaded',performSearchByCity)